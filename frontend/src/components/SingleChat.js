      ...
      {selectedChat ? (
        <>
          ...
          <Box d="flex" alignItems="center" justifyContent="center" h="100%">
            <Image src={require("../bluething.png")} alt="" height="250px" width="380px"/>
            </Box>
            <Text mt="-100px" fontSize="lg" fontWeight="bold" textAlign="center" >
            <div colostyle={{ color: "#61dbfb" , marginBottom:"10px" }}>   Let's Chat! </div>
              Start Conversations with Ease - Click on a User to Get Started.
            </Text>
            </>
      )}
    </>
